...
* Generated Code for OCTAL_LITERAL Token subclass
...
public class OCTAL_LITERAL extends Token {

    public OCTAL_LITERAL(TokenType type, SqlExprParserLexer tokenSource, int beginOffset, int endOffset) {
